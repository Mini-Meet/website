    ...
    const questionsAndAnswers = [
      {
        ...
        answer:
          'I need to focus on the one thing that will get me closer to achieving my goals.',
        delay: 1000,
      },
      {
        question: 'Why is this one thing so important?',
        answer:
          'I could focus on other things on my to-do list, but maybe they don`t matter',
        delay: 7000,
      },
      {
